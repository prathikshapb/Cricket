      ...
      <div className="container mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {videos.map((video, index) => (
            ...
            >
              <div className="relative aspect-video rounded-xl flex items-center justify-center overflow-hidden border border-border transition-transform duration-300 group-hover:-translate-y-1">
