      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          {sponsors.map((sponsor, index) => (
            <div
              key={sponsor.name}
              className="block rounded-xl border border-border bg-card p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:glow-gold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary animate-fade-up"
